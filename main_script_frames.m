...
imagePath = 'data/td_yaw3/gray_aamed/';
ellipsePath = 'data/td_yaw3/results.txt';
datasetPath = 'data/astrobee_colmap_groundtruth_ISS_yaw/';
posePath = 'data/td_yaw3/groundtruth.txt';
...
%%
circle_centers = cell(1, length(ellipse_result));
surface_normals = cell(1, length(ellipse_result));
T_iss_cam = cell(1, length(ellipse_result));
C_quad = cell(1, length(ellipse_result));
for i = 1:length(ellipse_result)
    % Set up params
