...
%     EstimatedPose{i} = EstimatedPose{best_k} * inv(T{i});
...
%  for cnt = 1:N
%      xi = pose_params_init((cnt-1)*6+1 : cnt*6);
%      T_rel = expSE3(xi);
...
objective_function=@(params) BA_motiononly_cost( ...
    params, InitialMap_PM, InitialMap_Win, C_pm_all,C_win_all,intrinsics,pose_index_map,tstamp,imagePath, imgList,ellipses_params);
