...
%     W_all(i, :) = P_world(1:3)';
% end
xyzPoints(2, :) =  Window_center_cam{1};% 아주 근처 
...
figure;
for i = 1:length(EstimatedPose)
    plot_camera_frame(EstimatedPose{i}(1:3,1:3), EstimatedPose{i}(1:3,4), 0.5, 'g');
    hold on;
end
