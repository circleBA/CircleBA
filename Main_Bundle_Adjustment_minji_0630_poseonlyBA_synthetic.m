...
objective_function=@(params) BA_motiononly_cost( ...
    params, InitialMap_PM, InitialMap_Win, C_pm_all,C_win_all,intrinsics.K,best_k,pose_index_map,T_ref,ellipses_params,T_p2c_cam_true);
...
function residuals = BA_motiononly_cost(params, PM3D, WIN3D, C_pm_all, C_win_all, K, best_k, pose_index_map,T_ref,ellipses_params,T_p2c_cam_true)
