...
function figure_detected_ellipse(imagePath, ellipses_params)
    % Read the image
    ...
    % Plot the ellipse
    plot(ellipse_points(1, :), ellipse_points(2, :), 'b', 'LineWidth', 1); 
    plot(major_axis_points(1, :), major_axis_points(2, :), 'r--', 'LineWidth', 1.5);
    plot(minor_axis_points(1, :), minor_axis_points(2, :), 'g--', 'LineWidth', 1.5); hold off;
