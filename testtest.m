...
% 
% imagePath = 'data/opti_ff_return_journey_forward/gray/';
% ellipsePath = 'data/opti_ff_return_journey_forward/results_p2c/';
% datasetPath = 'data/astrobee_colmap_groundtruth_ISS_yaw/';
% posePath = 'data/opti_ff_return_journey_forward/groundtruth.txt';
% droid_path = 'data/ff_return_journey_forward/DROID_P2C_ff_return_journey_forward.txt';
% orb_path = 'data/ff_return_journey_forward/ORB_P2C_ff_return_journey_forward.txt';
...
for i = 1:length(fileList)
    time = fileList(i).name(1:19); % 19
    imgName = [fileList(i).name(1:19),'.png']; % 19
